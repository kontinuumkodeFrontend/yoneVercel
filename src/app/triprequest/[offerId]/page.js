            ...
            <div className="row">
              <div className="col-xl-6">
                <div className="triprequest-img">
                  <img src={'/images/innerPages/rquestpage.png'} className="img-fluid" alt="img" />
                </div>
              </div>
              <div className="col-xl-6">
                <div className="mb-4">
                    ...
                    <div className="form-group col-fx-6">
                      ...
                      <div className="input-icon1">
                        <input
                          ...
                          id="source"
                          name="source"
                          className={`form-control ${formik.touched.source && formik.errors.source
                            ? "is-invalid"
                            : ""
                            }`}
                    ...
                    <div className="form-group col-fx-6">
                      ...
                      <div className="input-icon1">
                        <input
                          ...
                          className={`form-control ${formik.touched.destination &&
               ...
               <Carousel
                ...
                >
                  {offers.length > 0 ? (
                    ...
                    <Carousel.Item><div className="col-fx-4 cpn-cards">
